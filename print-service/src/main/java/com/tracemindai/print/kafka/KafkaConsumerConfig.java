...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, PrintRequestEvent> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE,
            PrintRequestEvent.class.getName());
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PrintRequestEvent>
            kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, PrintRequestEvent> factory =
