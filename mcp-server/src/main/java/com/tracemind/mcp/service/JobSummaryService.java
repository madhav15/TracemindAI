...
public class JobSummaryService {
    ...
    public JobSummaryService(SplunkQueryBuilder splunkQueryBuilder, SplunkClient splunkClient) {
        this.splunkQueryBuilder = splunkQueryBuilder;
        this.splunkClient = splunkClient;
    }

    public SplunkSearchResponse getJobSummary(String jobId) {
        String query = splunkQueryBuilder.buildJobSummaryQuery(jobId);
