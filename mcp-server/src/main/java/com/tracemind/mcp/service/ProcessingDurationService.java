...
@Service
public class ProcessingDurationService {

    private final SplunkQueryBuilder splunkQueryBuilder;
    private final SplunkClient splunkClient;

    public ProcessingDurationService(SplunkQueryBuilder splunkQueryBuilder, SplunkClient splunkClient) {
    ...
    public SplunkSearchResponse getProcessingDuration() {
        String query = splunkQueryBuilder.buildProcessingDurationQuery();
