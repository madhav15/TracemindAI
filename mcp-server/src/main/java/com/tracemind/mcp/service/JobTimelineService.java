...
public class JobTimelineService {
    ...
    public JobTimelineService(SplunkQueryBuilder splunkQueryBuilder, SplunkClient splunkClient) {
        this.splunkQueryBuilder = splunkQueryBuilder;
        this.splunkClient = splunkClient;
    }

    public SplunkSearchResponse getJobTimeline(String jobId) {
        String query = splunkQueryBuilder.buildJobTimelineQuery(jobId);
